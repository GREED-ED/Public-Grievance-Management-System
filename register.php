...
<head>
    ...
    <title>Register - Public Grievance Management System</title>
        ...
        <div class="flex flex-col justify-center items-center p-6 sm:p-8 lg:p-12 bg-white relative overflow-y-auto">
            ...
            <div class="w-full max-w-lg space-y-6 mt-10 lg:mt-0">
                <div class="text-center mb-8">
                    <h2 class="text-3xl font-black text-[#111418]">Create Account</h2>
        ...
        <div class="hidden lg:block relative bg-gray-900">
            ...
            <div class="relative z-10 flex flex-col justify-center h-full px-12 text-white">
                <div class="border-l-4 border-white pl-6 mb-6">
                    <h2 class="text-4xl font-black mb-4">Empowering Citizens</h2>
                    <p class="text-xl font-medium opacity-90">Building a transparent future together.</p>
                </div>
                ...
                <ul class="space-y-6 mt-8">
                    <li class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="font-bold text-lg">Fast Processing</p>
                            <p class="text-sm opacity-70">Direct connection to departments</p>
                        </div>
                    </li>
                    <li class="flex items-center gap-4">
                        <span class="size-10 rounded-full bg-white/20 flex items-center justify-center material-symbols-outlined">lock</span>
                        <div>
                            <p class="font-bold text-lg">Secure & Private</p>
                            <p class="text-sm opacity-70">Your data is encrypted and safe</p>
                        </div>
                    </li>
                    <li class="flex items-center gap-4">
                        ...
                        <div>
                            <p class="font-bold text-lg">Real-time Updates</p>
                            <p class="text-sm opacity-70">Get SMS alerts on status changes</p>
                        </div>
                    </li>
                </ul>
            </div>
