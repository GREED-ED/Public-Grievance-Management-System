    ...
    <script>
      tailwind.config = {
        ...
        theme: {
          extend: {
            colors: {
              "primary": "#DC143C", /* Changed to Nepal Crimson Red for authenticity */
...
<body class="bg-background-light dark:bg-background-dark text-[#111418] font-display overflow-x-hidden">
    ...
    <div id="mobile-menu" class="fixed inset-0 z-40 bg-black/50 hidden lg:hidden" onclick="toggleMenu()">
        <div class="absolute right-0 top-0 h-full w-64 bg-white p-5 shadow-xl transition-transform transform translate-x-full" onclick="event.stopPropagation()">
            <div class="flex justify-between items-center mb-6">
                <h3 class="font-bold text-lg">Menu</h3>
                <button onclick="toggleMenu()" class="text-gray-500 hover:text-red-600">
    ...
    <div class="relative flex min-h-screen w-full flex-col group/design-root">
        ...
        <main class="flex-1 flex flex-col items-center w-full">
            <div class="w-full bg-white pb-8">
                <div class="max-w-[1200px] mx-auto px-4 md:px-10 pt-6">
                    <div class="relative overflow-hidden rounded-xl bg-cover bg-center min-h-[400px] flex flex-col items-center justify-center text-center p-6 gap-6 shadow-md" 
                         style='background-image: linear-gradient(rgba(220, 20, 60, 0.9) 0%, rgba(0, 56, 147, 0.9) 100%), url("https://images.unsplash.com/photo-1544735716-392fe2489ffa?q=80&w=2671&auto=format&fit=crop");'>
                        ...
                        <div class="w-full max-w-lg z-10 mt-4">
                            <label class="flex flex-col h-14 md:h-16 w-full shadow-lg group focus-within:ring-4 ring-white/30 rounded-lg transition-all">
                                <div class="flex w-full flex-1 items-stretch rounded-lg bg-white overflow-hidden">
            ...
            <div class="w-full max-w-[1200px] px-4 md:px-10 -mt-16 md:-mt-20 z-20 mb-10">
                ...
                <div class="w-full lg:w-[360px] flex flex-col gap-6">
                    ...
                    <div class="rounded-xl bg-primary text-white p-6 relative overflow-hidden shadow-lg hover:scale-105 transition-transform cursor-pointer">
                        ...
                        <div class="relative z-10 flex flex-col gap-3">
                            <h4 class="font-bold text-lg">Need Assistance?</h4>
                            <p class="text-white/80 text-sm">Call our toll-free helpline for immediate support regarding your grievance.</p>
                            <div class="flex items-center gap-2 mt-2">
                                <span class="material-symbols-outlined">call</span>
                                <span class="text-2xl font-black">1111</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function submitForm() {
            const btn = document.querySelector('#complaint-modal button');
